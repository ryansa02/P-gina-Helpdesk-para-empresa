...
define('DB_NAME', 'csc_georgia');         // Nome do banco de dados
...
define('SESSION_SECRET', 'altere-esta-chave-secreta-para-producao');
define('JWT_SECRET', 'altere-esta-chave-jwt-para-producao');
