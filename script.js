...
const OWNER_EMAIL = 'seuemail@empresa.com';
...
document.addEventListener('DOMContentLoaded', () => {
    if (window.location.pathname.includes('dashboard.html')) {
        ...
        if (attCard) attCard.style.display = (usuario.email === OWNER_EMAIL) ? 'block' : 'none';
        listarChamados();
    }
...
function verChamado(id) {
    ...
    if(chamado){
        ...
        const historico = chamado.andamento && Array.isArray(chamado.andamento) ? chamado.andamento : [];
        ...
        const responsavelNome = (chamado.responsavel && chamado.responsavel === OWNER_EMAIL) ? 'Ryan Sá' : (chamado.responsavel || '—');
        const solicitanteNome = chamado.usuarioNome || getUsuarioNomeByEmail(chamado.usuarioEmail) || '—';
        
        body.innerHTML = `
            <div class="chamado-header holographic">
                <div class="chamado-id">#${chamado.id}</div>
                <div class="chamado-title">${chamado.titulo}</div>
                <div class="chamado-meta">
                    ${renderPrioridade(chamado.prioridade)}
            ...
            <div class="chamado-grid">
                ...
                <div class="info-card full-width">
                    ...
                    <div class="card-body">
                        <div class="description-text">${chamado.descricao}</div>
                    </div>
                </div>
